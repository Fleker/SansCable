...
<script>
	...
	<div class="colTop" onclick="moveCol(-1);" style="
		 position: fixed;
		top: 0px;
		left: 0px;
		height: 10%;
		...
		padding-left: 50px;
		"></div>
	<div class="colBot" onclick="moveCol(1);" style="
		position: fixed;
		left: 0px;
		height: 10%;
		top: 90%;
		...
		padding-left: 50px;
		"></div>
    <div class="gridTitle"><span id="gridTitle" style="font-weight:bold;">Please Wait</span>&nbsp;<span id="gridCount">(?)</span></div><div class="tileTitle" style="margin-left: 60px;font-size: 15pt;"></div>
    <div id="sample2-grid" class="grid" onmouseover=""></div>
